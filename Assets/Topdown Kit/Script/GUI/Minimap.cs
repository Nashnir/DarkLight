...
public class Minimap : MonoBehaviour {
    ...
    private Button ButtonMapUp, ButtonMapDown;
    private void Start()
    {
        ButtonMapUp = transform.Find("ButtonMapUp").GetComponent<Button>();
        ButtonMapDown = transform.Find("ButtonMapDown").GetComponent<Button>();
        ButtonMapUp.onClick.AddListener(OnButtonMapUpClick);
        ButtonMapDown.onClick.AddListener(OnButtonMapDownClick);

    }
    void OnButtonMapUpClick()
    {
        MinimapCamera.zoomLevel++;
        MinimapCamera.Instance.ZoomUpdate();
    }
    void OnButtonMapDownClick()
    {
        MinimapCamera.zoomLevel--;
        MinimapCamera.Instance.ZoomUpdate();
    }
